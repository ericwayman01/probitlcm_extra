...
This package, ``probitlcm_extra`` facilitates the creation of the files necessary for running a simulation using the `probitlcm <https://github.com/ericwayman01/probitlcm>`_ and `probitlcmlongit <https://github.com/ericwayman01/probitlcmlongit>`_ packages.
...
If you make use of ``probitlcm_extra``, please cite one of the above.
...
The instructions for using ``probitlcm_extra`` are contained within the documentation for the ``probitlcm`` and ``probitlcmlongit`` packages, available at https://ericwayman.net/software/docs/probitlcm/ and https://ericwayman.net/software/docs/probitlcmlongit/ .
